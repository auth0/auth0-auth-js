...
**Added**
- feat(auth0-server-js): export TokenExchangeError and MissingClientAuthError from public surface [\#195](https://github.com/auth0/auth0-auth-js/pull/195) ([cschetan77](https://github.com/cschetan77))
