...
- [Enterprise Connect — Domain Discovery](#enterprise-connect-domain-discovery)
    - [Checking Whether a Domain Is Federated](#checking-whether-a-domain-is-federated)
    - [Cache Behavior](#cache-behavior)
    - [Scheme Normalization](#scheme-normalization)
